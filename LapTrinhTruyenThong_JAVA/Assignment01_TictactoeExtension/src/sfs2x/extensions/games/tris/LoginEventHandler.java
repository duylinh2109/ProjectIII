...
public class LoginEventHandler extends BaseServerEventHandler
{
	...
	public void handleServerEvent(ISFSEvent event) throws SFSException
	{
        ...
        try
        {
	        ...
	        PreparedStatement stmt = connection.prepareStatement("SELECT password,id FROM account WHERE user_name=?");
			...
			session.setProperty(TrisExtension.DATABASE_ID, dbId);

...
public class TrisExtension extends SFSExtension
{
	...
	public void init()
	{
		trace("Tris game Extension for SFS2X started 14-08, rel. " + version);
	    ...
	    addRequestHandler("surrender", OnUserSurrenderHandler.class);
	    addRequestHandler("register", RegisterHandle.class);
	    addRequestHandler("getscore", GetScoreHandler.class);
	    addRequestHandler("getlb", GetLeaderBoardHandler.class);
	    addRequestHandler("challenge", ChallengeHandler.class);
	    addRequestHandler("agree", AgreeChallengeHandler.class);
	    addRequestHandler("changeskin", ChangeSkinSkillHandler.class);
	    addRequestHandler("hidemove", HideMoveSkillHandler.class);
	    addRequestHandler("daonguoc", DaoNguocSkillHandler.class);
	...
	{
		super.destroy();
		trace("Tris game destroyed!Ban moi cua Linh");
		//trace("Ban moi cua Linh");
	}
	...
	//Update Game Cho Spectator Khi Spectator vao ma game dang choi
